...
#include <complex>
#include <cmath>
#include <iostream>  // for cin and Complex
...
// For dealing with cin and std::complex ?
// No, morph into cin for Complex !
std::istream& operator>> (std::istream& is, Complex& z) {
  long double REAL, IMAGINARY;
  std::cout << "\nz = a + i b :\n";
  std::cout << "\nEnter real part as decimal number: a = ";
  is >> REAL;
  z._complex.real(REAL);
  std::cout << "\nEnter real b of imaginary part, i b: b = ";
  is >> IMAGINARY;
  z._complex.imag(IMAGINARY);
